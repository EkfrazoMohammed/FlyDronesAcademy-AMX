          ...
          <div className='max-w-[1280px] w-full px-6'>
            <div className="flex flex-col md:flex-row justify-between items-start">
              <div className="flex flex-col gap-2 w-[100%] text-primaryColor">
                  <div className="text[1.6rem] md:text-[2.8rem] font-medium">FlyDro Academy RPTO Location</div>
                <div className='flex gap-4'>
                <div className="text-[1.8rem] font-medium"> 
                  <img className="w-[70px] h-[55px] md:w-[80px] md:h-[80px]" src="https://aactxg.stripocdn.email/content/guids/CABINET_f37167ea2322984dfeb6a0a05e92d2480b49356b15fb055bb2ce2e84131a12e4/images/icon_04.png" alt="" />
                  </div>
