  ...
  return (
    <div className=" text-primaryColor md:min-h-[50vh]">
      <div className="w-full flex flex-col m-0 text-center items-center justify-center">
        ...
        <div
          className="w-full min-h-full md:min-h-[50vh]"
          style={{
            background:
              "linear-gradient(to right, #f8da5a 50%, rgba(244, 227, 59, 0)), url('https://aactxg.stripocdn.email/content/guids/CABINET_f37167ea2322984dfeb6a0a05e92d2480b49356b15fb055bb2ce2e84131a12e4/images/vector_01.JPG')",
