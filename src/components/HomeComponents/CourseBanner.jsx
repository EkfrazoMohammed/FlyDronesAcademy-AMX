...
const CourseBanner = () => {
  ...
  const handleSendEmailOtp = async () => {
    ...
    try {
      ...
      setErrorMessages((prev) => ({ ...prev, email: error.response.data.error }));
  ...
  const verifyOtp = async (type) => {
    try {
      ...
      if (response.data.message === 'OTP verified successfully') {
        ...
        setErrorMessages((prev) => ({ ...prev, [type]: 'Invalid OTP. Please try again.' }));
      }
    } catch (error) {
...
const handleSelectEvent = async (event) => {
  ...
  return (
    <div className="relative min-h-[720px] md:min-h-[80vh] color-primaryColor">
      ...
      {/* Mobile OTP Section */}
      <div>
        <label className="block text-sm font-medium text-gray-700 my-2">Mobile Number</label>
      ...
      {/* Email OTP Section */}
      <div>
        <label className="block text-sm font-medium text-gray-700 my-2 my-2">Email</label>
        <div className="mt-2 flex items-center justify-between">
          <input
            type="email"
            name="email"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 my-2">Address</label>
        <input
          type="text"
          name="address"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 my-2">Organization Name (optional)</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 my-2">GSTIN number (optional)</label>
        <input
          type="text"
          name="gstin"
