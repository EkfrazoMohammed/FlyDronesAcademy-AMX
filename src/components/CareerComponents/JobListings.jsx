...
// const JobListings = () => {
//   const [jobsData, setJobsData] = useState([]); // Default state is null
//   const fetchData = async () => {
//     try {
//       // Use the id in the API request
//       const response = await API.get(`department/`);
//       setJobsData(response?.data?.data); // Set the response data in state
//     } catch (error) {
...
//                           >
//                             <div className="para1">{role.name}</div>
...
const JobListings = () => {
  ...
  const handleOpenModal = (departmentName, roleName) => {
                    ...
                    {department.roles.map((role) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleOpenModal(department.name, role.name)
                          }
                        >
                          Apply Now
                        </button>
